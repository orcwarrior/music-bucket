/**
 * Created by orcwarrior on 2015-03-11.
 */

angular.module('musicBucketEngine')
  .factory('ngAudioMetadataParser', function () {
...
// metadataCallback, or invoke the errorCallback with an error message.
    function parse_audio_metadata(blob, metadataCallback, errorCallback) {
      ...
      function parseOggMetadata(header) {
        ...
        var p1_length = _.reduce(p1_segment_lengths, sum, 0);
        ...
        var p2_segment_lengths = header.getUnsignedByteArray(p2_header + 27,
          p2_num_segments);
        var p2_length = _.reduce(p2_segment_lengths, sum, 0);
    ...
    return function AudioMetadata(blob, metadataCallback, errorCallback) {
      return parse_audio_metadata(blob, metadataCallback, errorCallback);
    }
  });
